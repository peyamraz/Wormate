...
export interface Texts {
  ...
  shield: string; bonusSpeed: string; bonusCoin: string; bonusWide: string;
...
const en: Texts = {
  ...
  shield: 'SHIELD', bonusSpeed: 'SPEED', bonusCoin: 'GOLD', bonusWide: 'WIDE',
...
const tr: Texts = {
  ...
  shield: 'KALKAN', bonusSpeed: 'HIZ', bonusCoin: 'ALTIN', bonusWide: 'GENİŞ',
...
const es: Texts = {
  ...
  shield: 'ESCUDO', bonusSpeed: 'VELOCIDAD', bonusCoin: 'ORO', bonusWide: 'AMPLIO',
...
const fr: Texts = {
  ...
  shield: 'BOUCLIER', bonusSpeed: 'VITESSE', bonusCoin: 'OR', bonusWide: 'LARGE',
...
const de: Texts = {
  ...
  shield: 'SCHILD', bonusSpeed: 'SPEED', bonusCoin: 'GOLD', bonusWide: 'WEIT',
...
const pt: Texts = {
  ...
  shield: 'ESCUDO', bonusSpeed: 'VELOCIDADE', bonusCoin: 'OURO', bonusWide: 'AMPLO',
...
export function bonusLabel(kind: BonusKind): string {
  ...
  if (kind === 'wide') return t.bonusWide;
  return kind;
}
